...
2. Python 的赋值和引用
    ...
    - `copy, deepcopy` 的区别
        ...
        * ![](https://cdn.jsdelivr.net/gh/lpdswing/oss@main/202305181010449.png)
...
6. Python 性能之困
    ...
    3. GIL 全局解释器锁
        * 它确保任何时候都只有一个Python线程执行。
          ![](https://cdn.jsdelivr.net/gh/lpdswing/oss@main/202305181010949.png)
    4. 什么是进程、线程、协程？
...
9. Garbage Collection (GC)
    - 引用计数
        ...
        * 缺点: 消耗资源、循环引用
        ...
        ![](https://cdn.jsdelivr.net/gh/lpdswing/oss@main/202305181011763.png)
