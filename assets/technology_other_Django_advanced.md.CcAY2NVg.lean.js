import{j as n,b as a,c as p,a8 as l}from"./chunks/framework.BrpFzWtI.js";const u=JSON.parse('{"title":"django进阶-笔记","description":"","frontmatter":{"title":"django进阶-笔记","date":"2017-05-03T18:16:44.000Z","tags":["python","django"],"categories":["知识库"]},"headers":[],"relativePath":"technology/other/Django_advanced.md","filePath":"technology/other/Django_advanced.md","lastUpdated":1684399297000}'),e={name:"technology/other/Django_advanced.md"};function i(c,s,t,o,r,d){return a(),p("div",{"data-pagefind-body":!0},s[0]||(s[0]=[l(`<h1 id="django-进阶" tabindex="-1">Django 进阶 <a class="header-anchor" href="#django-进阶" aria-label="Permalink to &quot;Django 进阶&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1.  [HTTP Objects](https://docs.djangoproject.com/en/2.0/ref/request-response/)</span></span>
...
<span class="line"><span>      - 定期与源站做内容同步</span></span></code></pre></div>`,2)]))}const m=n(e,[["render",i]]);export{u as __pageData,m as default};
